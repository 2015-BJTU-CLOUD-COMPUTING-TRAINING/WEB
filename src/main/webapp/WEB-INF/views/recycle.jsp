            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link active" href="/cloud/indexview"><i class="glyphicon glyphicon-home"></i><span> 首页</span></a>
                        </li>
                        ...
                        <li class="active"><a class="ajax-link" href="/cloud/recycleview"><i class="glyphicon glyphicon-trash"></i><span> 回收站</span></a>
                        </li>

                        <li class="nav-header hidden-md">联系人/组</li>

                        <li><a class="ajax-link" href="/cloud/friendsview"><i class="glyphicon glyphicon-user"></i><span> 好友</span></a>
                        </li>
