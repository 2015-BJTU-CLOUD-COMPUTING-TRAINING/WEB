                        ...
                        <div class="box-header well" data-original-title="">
                            ...
                            <div class="pull-right" style="margin-top: -0.45%">
                                <a class="btn btn-default" onclick="chk('restore')" >
                                  ...
                                  <button type="button" class="btn btn-default" id="deletebutton" data-toggle="modal" onclick="showYNModal(this.value,'uploadId')" value="#myModal">
                                    ...
                                    <div class="modal-dialog" style="margin-top: 15%">
                                        <div class="modal-content" >
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">是否彻底删除？</h4>
                                            </div>
                                            <div class="row">
                                                <button class="col-md-2 col-md-offset-3 btn btn-success" data-dismiss="modal" type="button" onclick="Delete('deleteRecycleFile','uploadIds','uploadId')">是</button>
